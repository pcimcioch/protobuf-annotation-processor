    ...
    class Deserialization {
        ...
        void fullObject() throws IOException {
            ...
            RepeatableScalar record = deserialize(writer -> writer
                    ...
                    .sfixed64(12, 120L)
                    .sfixed64(12, 121L)
                    .boolUnpacked(13, List.of(true, false))
                    .string(14, "test1")
                    .string(14, "test2")
                    .bytes(15, ba(1, 2, 3))
        ...
        void partialObject() throws IOException {
            ...
            RepeatableScalar record = deserialize(writer -> writer
                    ...
                    .sint32(7, 71)
                    .sfixed32(11, 110)
                    .boolUnpacked(13, List.of(false, true, true))
                    .string(14, "test")
                    .string(14, "test")
            );
        ...
        void unknownFields() throws IOException {
            ...
            RepeatableScalar record = deserialize(writer -> writer
                    ...
                    .sfixed64(32, 1120L)
                    .sfixed64(32, 1121L)
                    .boolUnpacked(33, List.of(true, false))
                    .string(34, "test10")
                    .string(34, "test20")
                    .bytes(35, ba(5, 6, 7))
