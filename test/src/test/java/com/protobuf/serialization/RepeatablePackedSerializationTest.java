...
class RepeatablePackedSerializationTest extends SerializationTestBase {
    ...
    class Deserialization {
        ...
        void fullObject() throws IOException {
            ...
            RepeatablePacked record = deserialize(writer -> writer
                    .writeDoublePacked(1, 10d, 11d)
                    .writeFloatPacked(2, 20f, 21f)
                    .writeInt32Packed(3, 30, 31)
                    .writeInt64Packed(4, 40L, 41L)
                    .writeUint32Packed(5, 50, 51)
                    .writeUint64Packed(6, 60L, 61L)
                    .writeSint32Packed(7, 70, 71)
                    .writeSint64Packed(8, 80L, 81L)
                    .writeFixed32Packed(9, 90, 91)
                    .writeFixed64Packed(10, 100L, 101L)
                    .writeSfixed32Packed(11, 110, 111)
                    .writeSfixed64Packed(12, 120L, 121L)
                    .writeBoolPacked(13, true, false)
                    .writeInt32Packed(14, 2, 0)
            );
        ...
        void partialObject() throws IOException {
            // given when
            RepeatablePacked record = deserialize(writer -> writer
                    .writeDoublePacked(1, 10d)
                    .writeInt64Packed(4, 40L, 41L, 42L)
                    .writeSint32Packed(7, 70, 71)
                    .writeSfixed32Packed(11, 110)
                    .writeBoolPacked(13, false, true, true)
            );
        ...
        void fullObjectReverseOrder() throws IOException {
            ...
            RepeatablePacked record = deserialize(writer -> writer
                    .writeDoublePacked(1, 10d)
                    .writeSint32Packed(7, 70)
                    .writeInt32Packed(3, 30)
                    .writeFloatPacked(2, 20f)
                    .writeSfixed32Packed(11, 110)
                    .writeInt32Packed(3, 31)
                    .writeFixed64Packed(10, 100L)
                    .writeInt64Packed(4, 40L)
                    .writeUint32Packed(5, 50)
                    .writeSint32Packed(7, 71)
                    .writeFixed32Packed(9, 90)
                    .writeInt32Packed(14, 1)
                    .writeUint32Packed(5, 51)
                    .writeUint64Packed(6, 60L)
                    .writeDoublePacked(1, 11d)
                    .writeFloatPacked(2, 21f)
                    .writeUint64Packed(6, 61L)
                    .writeInt64Packed(4, 41L)
                    .writeBoolPacked(13, true)
                    .writeSint64Packed(8, 80L)
                    .writeSint64Packed(8, 81L)
                    .writeFixed32Packed(9, 91)
                    .writeSfixed64Packed(12, 120L)
                    .writeFixed64Packed(10, 101L)
                    .writeSfixed32Packed(11, 111)
                    .writeSfixed64Packed(12, 121L)
                    .writeBoolPacked(13, false)
                    .writeInt32Packed(14, 2)
            );
        ...
        void unknownFields() throws IOException {
            ...
            RepeatablePacked record = deserialize(writer -> writer
                    // unknown
                    .writeDoublePacked(21, 110d, 111d)
                    .writeFloatPacked(22, 120f, 121f)
                    .writeInt32Packed(23, 130, 131)
                    .writeInt64Packed(24, 140L, 141L)
                    .writeUint32Packed(25, 150, 151)
                    .writeUint64Packed(26, 160L, 161L)
                    .writeSint32Packed(27, 170, 171)
                    .writeSint64Packed(28, 180L, 181L)
                    .writeFixed32Packed(29, 190, 191)
                    .writeFixed64Packed(30, 1100L, 1101L)
                    .writeSfixed32Packed(31, 1110, 1111)
                    .writeSfixed64Packed(32, 1120L, 1121L)
                    .writeBoolPacked(33, true, false)
                    // record
                    .writeDoublePacked(1, 10d)
                    .writeFloatPacked(2, 20f)
                    .writeInt32Packed(3, 30)
    ...
    private RepeatablePacked deserialize(ThrowingConsumer<ProtobufEncoder> writerAction) throws IOException {
