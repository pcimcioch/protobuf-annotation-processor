...
class MessageDefinitionTest {
    ...
    void correctMessage() {
        ...
        FieldDefinition field1 = new FieldDefinition("test1", ScalarFieldType.BOOL, 0);
        FieldDefinition field2 = new FieldDefinition("test2", ScalarFieldType.INT32, 1);
        FieldDefinition field3 = new FieldDefinition("test3", ScalarFieldType.STRING, 2);
    ...
    void nullName() {
        // given
        FieldDefinition field = new FieldDefinition("test", ScalarFieldType.BOOL, 0);
    ...
    void duplicatedFieldName() {
        // given
        TypeName name = canonicalName("com.example.MyType");
        FieldDefinition field1 = new FieldDefinition("test", ScalarFieldType.BOOL, 0);
        FieldDefinition field2 = new FieldDefinition("test2", ScalarFieldType.INT32, 1);
        FieldDefinition field3 = new FieldDefinition("test", ScalarFieldType.STRING, 2);
    ...
    void duplicatedFieldNumbers() {
        ...
        FieldDefinition field1 = new FieldDefinition("test1", ScalarFieldType.BOOL, 0);
        FieldDefinition field2 = new FieldDefinition("test2", ScalarFieldType.INT32, 1);
        FieldDefinition field3 = new FieldDefinition("test3", ScalarFieldType.STRING, 0);

        // when then
        assertThatThrownBy(() -> new MessageDefinition(name, List.of(field1, field2, field3)))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Duplicated field number: 0");
    }
}